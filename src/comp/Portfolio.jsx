        ...
        <div className=" bg-gray-200">
            ...
            <div className=" grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 gap-4 p-3  ">
                ...
                <div className="group flex flex-col items-center  relative overflow-hidden">
                    ...
                    <br />
                    Api have products_name,products_price,products_description,products_rating,createdAt.Along the sorting the api can select data on the basis of distinct keys and add limits on data fetching
