            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 p-2" >
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/1.png" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/2.png" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/3.png" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/4.jpg" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/5.jpg" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
                ...
                <div className='group'>
                    <div className="transform translate-y-5 flex items-center justify-between bg-gray-100 rounded-lg p-4 mb-4 group-hover:translate-y-[-20] transition-transform duration-300">
                        <img src="../../images/6.png" alt='img' className="rounded-full h-16 w-16 mr-4" />
                        <div>
