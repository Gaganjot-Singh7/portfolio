  ...
  return (
    ...
    <div className='p-6 flex flex-col gap-2'>
        ...
        <div className=' '>
         ...
         <button className='bg-red-300 hover:bg-red-950 hover:rounded hover:text-white px-2  '><a href="/ResumeGaganjotsingh.pdf" download="ResumeGaganjotsingh">Download CV</a></button>
         </div>
    </div>
</div>
  )
